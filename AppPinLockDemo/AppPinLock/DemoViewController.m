...
//  AppPinLock
//
//  Created by Sumardi Shukor on 3/04/12.
//  Copyright 2012 Wutmedia. All rights reserved.
//
...
- (IBAction)showLockScreen:(UIButton *)button
{
    ...
    AppPinLock *lockScreen = [[AppPinLock alloc] initWithDelegate:self withDataSource:self];
...
#pragma mark - AppPinLock Delegate methods
...
#pragma mark - AppPinLock DataSource methods
- (int)unlockPasscode
{
